...
from .serializers import (
    RegisterCustomerSerializer, RegisterCustomerResponseSerializer, CheckEligibilitySerializer,
    CheckEligibilityResponseSerializer, CreateLoanSerializer,
    CustomerSerializer, ViewLoanSerializer, ViewLoansSerializer,
)
...
class CheckEligibilityView(APIView):
    def post(self, request):
        ...
        monthly_installment = calculate_emi(data['loan_amount'], corrected_interest, data['tenure']) if approval else None
...
class ViewLoansByCustomerView(APIView):
    def get(self, request, customer_id):
        ...
        serializer = ViewLoansSerializer(results, many=True)
        return Response(serializer.data, status=status.HTTP_200_OK)
